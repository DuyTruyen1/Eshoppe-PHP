   ...
   if(isset($_POST['submit'])){
       ...
       if(isset($_FILES['avatar'])){
           if(!empty($_FILES['avatar']['name'])){
               // Kiểm tra xem lỗi khi tải lên tệp tin 
               if($_FILES['avatar']['error'] > 0){
   				...
   				if(empty($err)){
   					// Lấy dữ liệu từ form
   					$email = $_POST['email'];
   					$password = md5($_POST['password']); // Mã hoá mật khẩu bằng MD5
   					$name = $_POST['name'];
   					...
   					$sql = "INSERT INTO user (email, pass, name, avatar) VALUES ('$email', '$password', '$name', $avatar_value)";
               ...
               <div class="row">
                  ...
                  <div class="col-md-8 clearfix">
                     <div class="shop-menu clearfix pull-right">
                        <ul class="nav navbar-nav">
                           <li><a href="add.php" id="admin"><i class="fa fa-user"></i> Admin</a></li>
