...
<html lang="en">
   <head>
      ...
      <title>LIST-PRODUCT | E-Shopper</title>
                  ...
                  <div class="col-sm-6">
                     <div class="contactinfo">
                        <ul class="nav nav-pills">
                           ...
                           <li><a href=""><i class="fa fa-envelope"></i> Truyenmap420gmail.com</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-sm-6">
                  ...
                  <div class="table-responsive cart_info">
                     <?php
                        ...
                        <tr role="row">
                          ...
                          <td>'.$value['title'].'</td>
                          <td>'.$value['price'].'</td>
                          <td><img width="50px" src='.$value['image'].' /></td>
                     ...
                     <table id="datatable" style="border: 1px solid ">
                        <thead>
                           <tr role="row" style="border: 1px solid">
                              <th>ID</th>
